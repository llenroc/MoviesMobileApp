...
namespace MoviesMobileApp.Service.Contracts
{
    public class ConfigClient : ServiceClient
    {
        ...
        public Task<Response<ServiceConfiguration>> GetServiceConfigAsync() => GetResponseDataAsync<ServiceConfiguration>($"{CONFIG_SEGMENT}{DATA_SEGMENT}");

        public Task<Response<GenresData>> GetGenresAsync() => GetResponseDataAsync<GenresData>($"{GENRES_SEGMENT}{DATA_SEGMENT}");
    }
}
